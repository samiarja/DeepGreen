...
% % %                     DS_F = imresize(S_F,1/40);
% % %                     %%%%%%%%%%%%%%%%%%%%%%%%%%%
% % %                     % Display the resized feature from 640x480 to 32x24
% % % 
% % %     %                 figure(6)
% % %     %                 for iNeuron = 1:nNeuron
% % %     %                     subplot(sqNeuron,sqNeuron,iNeuron)
...
% % %     %                 end
% % % 
% % %                     % Crop the image to 9x9 patches and flatten them
% % %     %                 figure(7)
% % %                     for iNeuron = 1:nNeuron
% % %     %                     subplot(sqNeuron,sqNeuron,iNeuron)
% % %     % %                     %                     loop_through_each_context = DS_F(:,:,iNeuron);
% % %                         thisDsf = DS_F(:,:,iNeuron);
% % % 
% % %                         A = numel(find(thisDsf(:)==0));
% % %                         B = numel(thisDsf(:));
% % % 
% % %                         if A==B
% % %                             finalImageNeighbour = [ 0 0 0; 0 0 0; 0 0 0];
% % %     %                         imagesc(finalImageNeighbour); colormap(hot);
% % %                         else
% % %                             [coordX coordY] = find(thisDsf==max(thisDsf(:)));
% % %                             finalImageNeighbour = [thisDsf(coordX-1,coordY-1) thisDsf(coordX-1,coordY) thisDsf(coordX-1,coordY+1);
% % %                                 thisDsf(coordX,coordY-1) thisDsf(coordX,coordY) thisDsf(coordX,coordY+1);
% % %                                 thisDsf(coordX+1,coordY-1) thisDsf(coordX+1,coordY) thisDsf(coordX+1,coordY+1)];
% % %     %                         imagesc(finalImageNeighbour); colormap(hot);
% % %                         end
% % %                         en(:,iNeuron) = finalImageNeighbour(:);
% % %                     end
% % %                 end
%             en2(:,idx) = en(:);
            %X = [X en];
